...
type Habitat = {
    ...
    level4Code: string,
    level4Label: string,
    distinctivenessCategory: keyof typeof distinctivenessCategories,
    distinctivenessScore: typeof distinctivenessCategories[keyof typeof distinctivenessCategories]['score'],
    distinctivenessTradingRules: typeof distinctivenessCategories[keyof typeof distinctivenessCategories]['suggestedAction'],
    technicalDifficultyCreation: keyof typeof difficulty,
    technicalDifficultyCreationMultiplier: typeof difficulty[keyof typeof difficulty],
    technicalDifficultyEnhancement: keyof typeof difficulty,
    technicalDifficultyEnhancementMultiplier: typeof difficulty[keyof typeof difficulty],
    description: string,
    conditionAssessmentNotes: string,
